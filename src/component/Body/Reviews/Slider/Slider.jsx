...
эффективную связь во время всего процесса.”"
        ...
        <SwiperSlide className={styels.Swiper}>
          {" "}
          {
            <Slide
              img={girl2}
              text="“С самого начала сотрудничества мы ощутили энтузиазм и внимание, которые WBM вкладывает в каждый проекте. Наша команда работала напрямую с их экспертами, и они проявили чрезвычайное понимание наших потребностей и целей.”"
            />
          }{" "}
        </SwiperSlide>
        <SwiperSlide className={styels.Swiper}>
